...
public struct InteractiveComponent: Component, Codable {
    ...
    public init(canDrag: Bool = true, pivotOnDrag: Bool = true, preserveOrientationOnPivotDrag: Bool = true, canScale: Bool = true, canRotate: Bool = true) {
